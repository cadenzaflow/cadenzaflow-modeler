...
Store element templates in this directory to use them in the CadenzaFlow Modeler. Alternatively, for element templates to be available across CadenzaFlow Modeler installations, you can store them in the `resources/element-templates` directory in the modeler's data directory. These templates will be available for all diagrams.
